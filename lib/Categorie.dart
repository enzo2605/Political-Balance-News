    ...
    return InkWell // PER INCLUDERE PICCOLA ANIMAZIONE AL TOCCO
      ...
      onTap: () {
        FocusScopeNode currentFocus = FocusScope.of(
            context); //LE RIGHE DI CODICE RIGUARDANTE IL FOCUS VENGONO UTILIZZATE
        // PER NON PERMETTERE AL CUPERTINOSEARCHTEXTFIELD(E' IN HOMEPAGE) DI CONTINUARE AD AVERE IL FOCUS
        if (!currentFocus.hasPrimaryFocus) {
          currentFocus.unfocus();
        }
        stc1.add(
            tipo1); // AL TOCCO COMUNICA AD UNO DEI TRE STREAM DELL'HOMEPAGE CHE E' ARRIVATO IL VALORE TIPO
...
class CatMod {
  String
      nomecat; // UTILIZZATO NEL FILE DATA.DART AI FINI DI IDENTIFICARE NOME E TIPO
  String tipo;
}
